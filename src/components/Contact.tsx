...
const Contact: React.FC = () => (
  <section id="contact" className="py-16 px-4">
    <div className="max-w-6xl mx-auto text-center rounded-3xl shadow-xl bg-white/70 backdrop-blur-md border border-[#b0abb9]/30 p-4 sm:p-8 md:p-16 lg:p-16 relative flex flex-col items-center">
